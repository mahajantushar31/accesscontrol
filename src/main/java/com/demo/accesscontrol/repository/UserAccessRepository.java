...
public interface UserAccessRepository extends JpaRepository<UserAccess, Long>{
	...
	@Query(value="SELECT * FROM user_access as e",nativeQuery = true)	
	public List<UserAccess> getAllUserAccessDetail()throws Exception;
		
	@Query(value="SELECT * FROM user_access e WHERE e.access_id = :access_id",nativeQuery = true)
	public UserAccess getUserAccessById(String access_id) throws Exception;
	
	@Query(value="SELECT * FROM user_access e WHERE e.access_name = :access_name",nativeQuery = true)
	public UserAccess getUserAccessByAccessName(String access_name) throws Exception;
